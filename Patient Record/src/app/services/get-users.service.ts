...
export class GetUsersService {
  ...
  update_url = "http://127.0.0.1:8000/update_user?patientname="
  ...
  get_data(patientname:string){
    let get_user_url = "http://localhost:8000/user_by_patientname?patientname="+patientname
  ...
  delete_user(data:string){
    let delete_url = "http://localhost:8000/delete_user?patientname=" +data
